module Bitex
  module JsonApi
    ...
    # Revoke your API keys immediately if you think they're compromised.  You need to Log in or Sign Up in order to create API Keys and use our Private Trading API.
    class ApiKey < Base
      # POST /api/api_keys
      #
      # Create an Api Key.
      ...
      def self.valid_otp_code?(otp_code)
        ...
        return false if !otp_code.try(:to_i).is_a?(Numeric)
      end
    end
  end
end
