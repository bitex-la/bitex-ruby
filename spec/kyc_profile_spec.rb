...
describe Bitex::KycProfile do
  ...
  let(:params_for_create_or_update) do
    {
      ...
      tax_id: '4332221115',
      birth_date: Time.at(946685400).utc,
  ...
  it 'creates a new kyc profile' do
    stub_private(:post, '/private/kyc_profiles', 'kyc_profile', rest_params_for_create_or_update)
    Bitex::KycProfile.create!(params_for_create_or_update).should be_a Bitex::KycProfile
  end
  ...
  it 'updates a kyc profile' do
    stub_private(:put, '/private/kyc_profiles/1', 'kyc_profile', rest_params_for_create_or_update)
